...
public:
	...
	void Insert(const char* str, uint key_len);
	int Query(const char* str, uint key_len);
	void Delete(const char* str, uint key_len);
...
void PCM_Sketch::Insert(const char* str, uint key_len)
{
...
int PCM_Sketch::Query(const char* str, uint key_len)
{
	int min_value = 1 << 30;
...
void PCM_Sketch::Delete(const char* str, uint key_len)
{
